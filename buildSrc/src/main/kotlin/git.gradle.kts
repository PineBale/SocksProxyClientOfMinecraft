...
if (gitShaRevOutput != "local") {
    val gitDiffProcess =
        runProcess("git diff --quiet --ignore-space-at-eol --text ${project.projectDir.absolutePath}/src/main/kotlin/**/*.kt ${project.projectDir.absolutePath}/src/main/java/**/*.java ${project.projectDir.absolutePath}/*.gradle.kts ${project.projectDir.absolutePath}/gradle.properties ${project.projectDir.absolutePath}/src/main/resources/**")
    if (gitDiffProcess == 1) {
